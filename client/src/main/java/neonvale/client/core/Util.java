...
import neonvale.client.core.assets.TextureColorSpace;
...
public class Util {
    public static int create1x1Texture(int r, int g, int b, int a, TextureColorSpace colorSpace) {
        ...
        glTexImage2D(GL_TEXTURE_2D, 0, internalFormat, 1, 1, 0, GL_RGBA, GL_UNSIGNED_BYTE, buffer);
